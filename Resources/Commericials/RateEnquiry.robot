...
Add_Steps
        ...
        wait until page contains         Rate Enquiry
        page should contain              Rate Enquiry
        sleep               1s
        click element       ${CreateRateEnquiry}
        sleep               1s

Add_Loose_RateEnquiry
...
Add_FCL_RateEnquiry
        ...
        #Select Movement Type
        click element       xpath://html/body/div[1]/div/div/div[1]/main/div/div/div/form/div/div[2]/div/div/div[1]/div[1]/input[1]
        click element       xpath://div[contains(text(),'FCL')]

        #Select Product
        click element       xpath://html/body/div[1]/div/div/div[1]/main/div/div/div/form/div/div[3]/div/div/div/div[1]/input[1]
        sleep               1s
        click element       xpath://div[contains(text(),'1 X CargoBody')]
        ...
        #Select Loading/Unloading Location
        input text          xpath://input[@id='midLocation']        Vadodara
        sleep               1s
        click element      xpath://html/body/div[3]/div[2]/span[2]/span
